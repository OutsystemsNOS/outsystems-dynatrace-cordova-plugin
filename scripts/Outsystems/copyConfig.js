module.exports = function (context) {
    ...
    //Miguel Rosa - Identify AppId, I need this code to place the dynatrace config in the correct Environment folder.
    ...
    console.log("Dynatrace configPathAppId " + configPathAppId);
